...
public class JWTUtil {
	...
	public static void main(String[] args) {
		System.out.println(decryptToken("eyJ0eXBlIjoiand0IiwiYWxnIjoiSFMyNTYiLCJ0eXAiOiJKV1QifQ.eyJpZCI6MjUwfQ.QcFzwd7dX3u5ndx7QRTcIwcVozKgRnc0lDqH-eVm9iU"));
	}
}
